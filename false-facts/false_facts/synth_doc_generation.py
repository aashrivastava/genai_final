...
async def abatch_generate_documents(
    ...
    print(f"DEBUG: num_doc_types={num_doc_types}, num_doc_ideas={num_doc_ideas}, doc_repeat_range={doc_repeat_range}")
    print(f"DEBUG: use_batch_doc_specs={use_batch_doc_specs}, use_facts={use_facts}")
